...
public class NZWalksDbContext(DbContextOptions<NZWalksDbContext> options) : DbContext(options)
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        var difficulties = new List<Difficulty>()
        {
            new Difficulty()
            {
                Id = Guid.Parse("54b579a3-5482-42ec-91d7-c252bd22c1d5"),
                Name = "Easy"
            },
            new Difficulty()
            {
                Id = Guid.Parse("4a86b53a-3b5e-4619-b0fa-0d1e05de0f35"),
                Name = "Medium"
            },
            new Difficulty()
            {
                Id = Guid.Parse("e3d9eab5-b09c-4042-8c8e-fd9be7715d40"),
                Name = "Hard"
            },
        };
