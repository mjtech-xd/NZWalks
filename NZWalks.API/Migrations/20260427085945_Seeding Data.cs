    ...
    public partial class SeedingData : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { new Guid("4a86b53a-3b5e-4619-b0fa-0d1e05de0f35"), "Medium" },
                    { new Guid("54b579a3-5482-42ec-91d7-c252bd22c1d5"), "Easy" },
                    { new Guid("e3d9eab5-b09c-4042-8c8e-fd9be7715d40"), "Hard" }
                });
        ...
        protected override void Down(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.DeleteData(
                table: "Difficulties",
                keyColumn: "Id",
                keyValue: new Guid("4a86b53a-3b5e-4619-b0fa-0d1e05de0f35"));

            migrationBuilder.DeleteData(
                table: "Difficulties",
                keyColumn: "Id",
                keyValue: new Guid("54b579a3-5482-42ec-91d7-c252bd22c1d5"));

            migrationBuilder.DeleteData(
                table: "Difficulties",
                keyColumn: "Id",
                keyValue: new Guid("e3d9eab5-b09c-4042-8c8e-fd9be7715d40"));
